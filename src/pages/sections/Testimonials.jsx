  ...
  return (
    <section className="max-w-[1140px] mx-auto py-[56px] px-4 sm:px-6 lg:px-0">
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-6">
        ...
        <div className="w-full lg:w-[256px] lg:h-[139px] flex flex-col gap-3 text-center lg:text-left flex-shrink-0">

          <p className="text-[#096B58] text-[14px] font-medium leading-none uppercase">
            WHAT OUR PATIENTS SAY
          </p>

          <h2 className="text-[30px] sm:text-[36px] lg:text-[28px] font-medium leading-[38px] text-[#141414]">
            Trusted by Millions
          </h2>

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="ml-[250px] pt-[60px]">
        <div className="p-6">
          ...
          <TableContainer
            component={Paper}
            className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-none"
          >
            <Table className="w-full">
              {/* Table Header */}
              <TableHead className="bg-gray-50">
                <TableRow>
                  <TableCell className="!font-semibold !text-gray-800 !py-4 !px-5 !border-b-0">
                    Customer
                  </TableCell>
                  <TableCell className="!font-semibold !text-gray-800 !py-4 !px-5 !border-b-0">
                    Product
              ...
              <TableBody>
                {paginatedReviews.length > 0 ? (
                  paginatedReviews.map((review) => (
                    ...
                    >
                      {/* Customer */}
                      <TableCell className="!py-4 !px-5 !text-gray-800 !border-b-0">
                        {review.customer}
                      </TableCell>
                      ...
                      {/* Review */}
                      <TableCell className="!py-4 !px-5 !text-gray-600 !border-b-0">
                        {review.review}
                      </TableCell>
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={6}
                      align="center"
                      className="!py-10 !text-gray-500 !border-b-0"
                    >
                      No reviews found
                    </TableCell>
                  </TableRow>

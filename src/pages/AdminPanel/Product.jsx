...
import { productValidationSchema , categoryValidationSchema } from "@/shared/validation/Productvalidation";
  ...
  <div className="fixed inset-0 bg-black/5 flex items-center justify-center z-50 p-4">
    <div className="bg-white rounded-lg max-w-md w-full p-6">
      ...
      <p className="text-gray-600 text-center mb-2">
        <span className="font-semibold">"{categoryDeleteError.category.name}"</span> contains 
        <span className="font-semibold text-red-600"> {categoryDeleteError.productCount} </span> 
        product(s).
      </p>
      ...
      <div className="bg-linear-to-r from-blue-600 to-indigo-700 px-6 py-5">
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">{showProductDetail.name}</h2>
              <p className="text-blue-100 text-sm">{showProductDetail.category}</p>
            </div>
          </div>
          <button
      ...
      <div className="p-6">
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <p className="text-xl font-bold text-gray-900">₹{showProductDetail.price}</p>
            {showProductDetail.originalPrice && (
              <p className="text-sm text-gray-400 line-through">₹{showProductDetail.originalPrice}</p>
            )}
          </div>
          <div className="bg-gray-50 rounded-xl p-4">
            <p className="text-sm text-gray-500">Stock</p>
            <p className="text-xl font-bold text-gray-900">{showProductDetail.stock} units</p>
            <div className="w-full bg-gray-200 rounded-full h-1.5 mt-2">
              <div 
                className="bg-linear-to-r from-blue-500 to-indigo-600 h-1.5 rounded-full transition-all"
                style={{ width: `${Math.min((showProductDetail.stock / 50) * 100, 100)}%` }}
              />
            </div>
          </div>
        </div>
